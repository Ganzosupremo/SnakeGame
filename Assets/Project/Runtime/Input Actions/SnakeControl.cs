...
namespace SnakeInput
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CheatWindow"",
                    ""type"": ""Button"",
                    ""id"": ""77fd87db-44c7-4c4f-b763-460a97082d91"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""EnterCommand"",
                    ""type"": ""Button"",
                    ""id"": ""588b50dc-7895-4f16-b8b5-bf5acda7da02"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6f2b6446-2529-4b05-9faf-5f6bf3bafcca"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9fe5d7af-a4c4-4819-ab90-98fd384d9657"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Snake_CheatWindow = m_Snake.FindAction("CheatWindow", throwIfNotFound: true);
            m_Snake_EnterCommand = m_Snake.FindAction("EnterCommand", throwIfNotFound: true);
            // OverviewMap
        ...
        private readonly InputAction m_Snake_CheatWindow;
        private readonly InputAction m_Snake_EnterCommand;
        public struct SnakeActions
        {
            ...
            public InputAction @CheatWindow => m_Wrapper.m_Snake_CheatWindow;
            public InputAction @EnterCommand => m_Wrapper.m_Snake_EnterCommand;
            ...
            public void AddCallbacks(ISnakeActions instance)
            {
                ...
                @CheatWindow.started += instance.OnCheatWindow;
                @CheatWindow.performed += instance.OnCheatWindow;
                @CheatWindow.canceled += instance.OnCheatWindow;
        ...
        public interface ISnakeActions
        {
            ...
            void OnCheatWindow(InputAction.CallbackContext context);
