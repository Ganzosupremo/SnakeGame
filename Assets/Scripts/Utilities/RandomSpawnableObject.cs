    ...
    public class RandomSpawnableObject<T>
    {
        ...
        public T RandomMapItem
        {
            get
            {
                ...
                foreach (SpawnableObject<T> spawnableObjects in m_SpawnableObjects)
                {
                    // Check if it is the current level
